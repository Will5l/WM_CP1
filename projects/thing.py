...
def attacks(dex,ac,str,low,high,hp,shp):
    ...
    if turn == "1" or turn == 1:
        ...
        if attack > ac:
            ...
            hit = False
    elif turn == "2" or turn == 2 and user_class != "Mage":
        attack = dex+random.randint(1,20)
        if attack > ac:
            hit = True
    ...
    while True:
        ...
        if user_class == "Fighter":
            ...
            if turn == 3 and health_potions > 0:
                ...
                break
            if turn == "4":
                flee = dex_mod+random.randint(1,20)
                if flee > 16:
                    print("You fled")
                    fled = True
                    break
            ...
            if turn == 2:
                ...
                if mon_dex_mod+random.randint(1,20) > 16:
                    damage = random.randint(1,6)+random.randint(1,6)+random.randint(1,6)
                    mon_health -= damage
                else:
                    damage = random.randint(1,6)+random.randint(1,6)+random.randint(1,6)+random.randint(1,6)+random.randint(1,6)+random.randint(1,6)
                    mon_health -= damage
